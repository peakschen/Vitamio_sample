  ...
  public MediaPlayer(Context ctx, boolean preferHWDecoder) {
    ...
    if (preferHWDecoder) {
      ...
      try {
        ...
        Logs.e("unloadOMX failed %s", e.toString());
      }
  ...
  static {
    ...
    load_lib(  LIB_ROOT ,  "libvplayer.so");
      ...
      if (!vvo_loaded) {
        ...
        Logs.d("FALLBACK TO VVO JNI " + vvo_loaded);
      }
      loadVAO_native_lib( LIB_ROOT ,  "libvao.0.so");
    } catch (java.lang.UnsatisfiedLinkError e) {
      Logs.e("Error loading libs", e);
    }
  }
...
//        //Log.i("MiuiVideo: get message after player released, msg type: " + msg.what);
      ...
      switch (msg.what) {
        ...
        case MEDIA_SET_VIDEO_SIZE:
          ...
          return;
        case MEDIA_ERROR:
          Logs.e("Error (%d, %d)", msg.arg1, msg.arg2);
          ...
          return;
        case MEDIA_INFO:
          Logs.i("Info (%d, %d)", msg.arg1, msg.arg2);
          if (mOnInfoListener != null)
            mOnInfoListener.onInfo(mMediaPlayer, msg.arg1, msg.arg2);
          return;
        case MEDIA_CACHE:
        ...
        case MEDIA_TIMED_TEXT:
          ...
          if (mData.getInt(MEDIA_SUBTITLE_TYPE) == SUBTITLE_TEXT) {
            Logs.i("Subtitle : %s", mData.getString(MEDIA_SUBTITLE_STRING));
        ...
        case MEDIA_HW_ERROR:
        	...
        	return;
        default:
          Logs.e("Unknown message type " + msg.what);
          return;
      }
    }
  }
