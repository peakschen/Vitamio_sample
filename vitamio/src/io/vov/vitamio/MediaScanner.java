...
public class MediaScanner {
  ...
  public void scanDirectories(String[] directories) {
    try {
      ...
      Logs.d(" prescan time: %dms", prescan - start);
      Logs.d("    scan time: %dms", scan - prescan);
      Logs.d("postscan time: %dms", end - scan);
      Logs.d("   total time: %dms", end - start);
    } catch (SQLException e) {
      Logs.e("SQLException in MediaScanner.scan()", e);
    } catch (UnsupportedOperationException e) {
      Logs.e("UnsupportedOperationException in MediaScanner.scan()", e);
    } catch (RemoteException e) {
      Logs.e("RemoteException in MediaScanner.scan()", e);
    }
  }
  ...
  public Uri scanSingleFile(String path, String mimeType) {
    try {
      ...
      Logs.e("RemoteException in MediaScanner.scanFile()", e);
      return null;
    }
  }
  ...
  private class MyMediaScannerClient implements MediaScannerClient {
    ...
    public void handleStringTag(String name, byte[] valueBytes, String valueEncoding) {
      ...
      try {
        ...
        Logs.e("handleStringTag", e);
        value = new String(valueBytes);
      }
      Logs.i("%s : %s", name, value);
